...
function StageScenarios({ onNav }) {
  ...
  return (
    <div>
      <StageHeader n="10" title="Risk & Scenarios" kicker="Control tower · Monte Carlo · sensitivity · TCO · EVM · what-if — sub-tabbed by intent (P2)"
...
function ScnRisk() {
  return (
    <Grid cols={2}>
      <Card icon="🚨" title="Control Tower" badge={`${M.controlTower.length} alerts`} badgeTone="k" info={{ what:'Live exception monitor.', flows:'Drill into owning stage.' }}
        dev={{ comp:'AnalysisTab', props:'state, dispatch', state:'analysis.alerts[]' }}>
